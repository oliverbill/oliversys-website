...
description: "Traditional TDD costs €25k–€80k on a €500k check. The math does not work, so diligence gets skipped. The price point has changed. The gap has not closed yet."
...
Iberian seed funds skip technical diligence because the math does not work. A €25k to €80k traditional review on a €500k check is 5 to 16 percent of the round. Nobody spends that. So what happens instead? An hour on a Zoom call, a CTO who nods a lot, and a signature that later reads as "we should have caught this."
...
This is why the incumbent structure cannot solve the problem. The pricing is not the result of inefficiency. It is the result of labor economics: senior engineers in London, Madrid, and Lisbon who could be doing this work are hired by consultancies that charge for headcount. The headcount floor is €25k. Below that, the math does not close for the supplier either.
